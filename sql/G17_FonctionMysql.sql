-- VERSION MySQL - Groupe 17 – Fonctions Politiques
...
CREATE TABLE G17_Responsable_Politique (
    ...
    rp_dateDeces DATE,
    CHECK (rp_dateDeces IS NULL OR rp_dateDeces >= rp_dateNaissance)
);

-- Table : Fonctions politiques

CREATE TABLE G17_Fonction (
    fonc_id INT AUTO_INCREMENT PRIMARY KEY,
    fonc_titre VARCHAR(80) NOT NULL,
    fonc_modNomination VARCHAR(80) NOT NULL
);

-- Table d’association : Exercer 
